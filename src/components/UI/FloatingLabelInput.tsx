    ...
    return (
      <div className="relative">
        <input
          ref={ref}
          placeholder=" "
          className={`peer block w-full px-4 py-3.5 border-2 border-gray-200 rounded-lg focus:outline-none focus:ring-2 ${colors.ring} ${colors.border} transition-all placeholder-transparent min-h-[52px] ${className}`}
          {...props}
        />

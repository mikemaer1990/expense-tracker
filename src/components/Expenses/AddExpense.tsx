...
import { MagnifyingGlassIcon, XMarkIcon, BanknotesIcon, ChartBarIcon, SparklesIcon, PlusIcon } from '@heroicons/react/24/outline'
      ...
      <div className="relative mx-auto border shadow-lg bg-white
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4 p-6">
            <div>
              ...
              <div className="grid grid-cols-3 gap-3">
                {categories.map((category) => {
                  ...
                  // Icon mapping
                  const CategoryIcon = category.name.toLowerCase().includes('fixed')
                    ? BanknotesIcon
                    : category.name.toLowerCase().includes('variable')
                    ? ChartBarIcon
                    : SparklesIcon
                  ...
                  return (
                    <button
                      ...
                      className={`
                        ...
                        ${isSelected
                          ? 'border-transparent bg-gradient-to-br from-blue-50 to-indigo-50 shadow-md shadow-blue-200/30'
                    ...
                    >
                      ...
                      {isSelected && (
                        <div className="absolute inset-0 rounded-xl bg-gradient-to-br from-blue-500 to-indigo-500 -z-10 p-[2px]">
                          <div className="h-full w-full bg-white rounded-xl"></div>
                        </div>
                      )}

                      <div className="flex flex-col items-center gap-2">
                        <CategoryIcon className={`h-6 w-6 ${isSelected ? 'text-blue-600' : 'text-gray-500'}`} />
            ...
            <div>
              ...
              {/* Search Input */}
              {selectedCategoryId && expenseTypes.length > 0 && (
